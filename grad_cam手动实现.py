...
if __name__ == '__main__':
    ...
    for count,(name, child) in enumerate(model.named_children()):  # named_modules  named_children
        ...
        # 注意这里区别:
        # 调整前: 计数: 2         模块的名字是: relu      模块本身是: <class 'torch.nn.modules.activation.ReLU'>
        # 调整后: 计数: 2         模块的名字是: relu      模块本身是: <class '__main__.GuidedBackpropReLU_Module_by_cxq'>
        ...
        # 调整前: 计数: 148       模块的名字是: layer4.2.relu     模块本身是: <class 'torch.nn.modules.activation.ReLU'>
        # 调整后: 计数: 148       模块的名字是: layer4.2.relu     模块本身是: <class '__main__.GuidedBackpropReLU_Module_by_cxq'>
    # -----------------------------------------------------------------------------------
