...
checkpoint = torch.load('./model/resnet50-19c8e357.pth')
model.load_state_dict(checkpoint)

# 2.选择目标层
target_layer = model.layer4[-1]
# 3. 构建输入图像的Tensor形式
image_path = './examples/9.png'
...
# 6. 计算cam
grayscale_cam = cam(input_tensor=input_tensor, target_category=target_category,aug_smooth=True,eigen_smooth=True)  # [batch, 224,224]
